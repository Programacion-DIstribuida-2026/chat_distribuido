...
Opcional: levantar también phpMyAdmin en [http://127.0.0.1:8080](http://127.0.0.1:8080):
...
- Documentación interactiva: [http://127.0.0.1:9000/docs](http://127.0.0.1:9000/docs)  
- **Chat en el navegador:** [http://127.0.0.1:9000/chat](http://127.0.0.1:9000/chat) (solo en el mismo PC que corre el servidor).
...
2. **Mismo PC, dos pestañas:** abre dos veces [http://127.0.0.1:9000/chat](http://127.0.0.1:9000/chat).
